...
sudo apt install -y chromium-browser compton geany filezilla vlc gparted clementine compizconfig-settings-manager hexchat virt-manager curl whois pcmanfm nextcloud-client psensor vim i3 i3blocks xautolock suckless-tools apg htop transmission-gtk git policykit-desktop-privileges policykit-1-gnome net-tools
